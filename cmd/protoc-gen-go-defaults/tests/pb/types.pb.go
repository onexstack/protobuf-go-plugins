...
import (
	_ "github.com/onexstack/protobuf-go-plugins/defaults"
...
const file_tests_pb_types_proto_rawDesc = "" +
	"\n" +
	"\x14tests/pb/types.proto\x12\x05tests\x1a\x17defaults/defaults.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\"\xe8\f\n" +
	"\x05Types\x12\x1e\n" +
	"\x05float\x18\x01 \x01(\x02B\b\x9aI\x05\r=\n" +
	"\xd7>R\x05float\x12$\n" +
	"\x06double\x18\x02 \x01(\x01B\f\x9aI\t\x11\xe1z\x14\xaeG\xe1\xda?R\x06double\x12\x1b\n" +
	"\x05int32\x18\x03 \x01(\x05B\x05\x9aI\x02\x18*R\x05int32\x12\x1b\n" +
	"\x05int64\x18\x04 \x01(\x03B\x05\x9aI\x02 *R\x05int64\x12\x1d\n" +
	"\x06uint32\x18\x05 \x01(\rB\x05\x9aI\x02(*R\x06uint32\x12\x1d\n" +
	"\x06uint64\x18\x06 \x01(\x04B\x05\x9aI\x020*R\x06uint64\x12\x1d\n" +
	"\x06sint32\x18\a \x01(\x11B\x05\x9aI\x028TR\x06sint32\x12\x1d\n" +
	"\x06sint64\x18\b \x01(\x12B\x05\x9aI\x02@TR\x06sint64\x12\"\n" +
	"\afixed32\x18\t \x01(\aB\b\x9aI\x05M*\x00\x00\x00R\afixed32\x12&\n" +
	"\afixed64\x18\n" +
	" \x01(\x06B\f\x9aI\tQ*\x00\x00\x00\x00\x00\x00\x00R\afixed64\x12$\n" +
	"\bsfixed32\x18\v \x01(\x0fB\b\x9aI\x05]*\x00\x00\x00R\bsfixed32\x12(\n" +
	"\bsfixed64\x18\f \x01(\x10B\f\x9aI\ta*\x00\x00\x00\x00\x00\x00\x00R\bsfixed64\x12\x19\n" +
	"\x04bool\x18\r \x01(\bB\x05\x9aI\x02h\x01R\x04bool\x12\x1f\n" +
	"\x06string\x18\x0e \x01(\tB\a\x9aI\x04r\x0242R\x06string\x12\x1d\n" +
	"\x05bytes\x18\x0f \x01(\fB\a\x9aI\x04z\x0242R\x05bytes\x12-\n" +
	"\x04enum\x18\x10 \x01(\x0e2\x11.tests.Types.EnumB\x06\x9aI\x03\x80\x01\x01R\x04enum\x124\n" +
	"\amessage\x18\x11 \x01(\v2\x0e.tests.MessageB\n" +
	"\x9aI\a\x8a\x01\x04\b\x01\x10\x00R\amessage\x12/\n" +
	"\x03one\x18\x1d \x01(\v2\x0f.tests.OneOfOneB\n" +
	"\x9aI\a\x8a\x01\x04\b\x01\x10\x01H\x00R\x03one\x12/\n" +
	"\x03two\x18\x1e \x01(\v2\x0f.tests.OneOfTwoB\n" +
	"\x9aI\a\x8a\x01\x04\b\x01\x10\x01H\x00R\x03two\x125\n" +
	"\x05three\x18\x1f \x01(\v2\x11.tests.OneOfThreeB\n" +
	"\x9aI\a\x8a\x01\x04\b\x01\x10\x01H\x00R\x05three\x12/\n" +
	"\x04four\x18  \x01(\x0e2\x11.tests.Types.EnumB\x06\x9aI\x03\x80\x01\x01H\x00R\x04four\x12?\n" +
	"\bduration\x18\x12 \x01(\v2\x19.google.protobuf.DurationB\b\x9aI\x05\xaa\x01\x022dR\bduration\x12C\n" +
	"\ttimestamp\x18\x13 \x01(\v2\x1a.google.protobuf.TimestampB\t\x9aI\x06\xb2\x01\x03nowR\ttimestamp\x12M\n" +
	"\fdouble_value\x18\x14 \x01(\v2\x1c.google.protobuf.DoubleValueB\f\x9aI\t\x11\xe1z\x14\xaeG\xe1\xda?R\vdoubleValue\x12F\n" +
	"\vfloat_value\x18\x15 \x01(\v2\x1b.google.protobuf.FloatValueB\b\x9aI\x05\r=\n" +
	"\xd7>R\n" +
	"floatValue\x12C\n" +
	"\vint64_value\x18\x16 \x01(\v2\x1b.google.protobuf.Int64ValueB\x05\x9aI\x02 *R\n" +
	"int64Value\x12F\n" +
	"\fuint64_value\x18\x17 \x01(\v2\x1c.google.protobuf.UInt64ValueB\x05\x9aI\x020*R\vuint64Value\x12C\n" +
	"\vint32_value\x18\x18 \x01(\v2\x1b.google.protobuf.Int32ValueB\x05\x9aI\x02\x18*R\n" +
	"int32Value\x12F\n" +
	"\fuint32_value\x18\x19 \x01(\v2\x1c.google.protobuf.UInt32ValueB\x05\x9aI\x02(*R\vuint32Value\x12@\n" +
	"\n" +
	"bool_value\x18\x1a \x01(\v2\x1a.google.protobuf.BoolValueB\x05\x9aI\x02h\x00R\tboolValue\x12H\n" +
	"\fstring_value\x18\x1b \x01(\v2\x1c.google.protobuf.StringValueB\a\x9aI\x04r\x0242R\vstringValue\x12E\n" +
	"\vbytes_value\x18\x1c \x01(\v2\x1b.google.protobuf.BytesValueB\a\x9aI\x04z\x0242R\n" +
	"bytesValue\"\"\n" +
	"\x04Enum\x12\b\n" +
	"\x04NONE\x10\x00\x12\a\n" +
	"\x03ONE\x10\x01\x12\a\n" +
	"\x03TWO\x10\x02B\x0f\n" +
	"\x05oneof\x12\x06\x9aI\x03two\"2\n" +
	"\aMessage\x12'\n" +
	"\x05field\x18\x01 \x01(\tB\x11\x9aI\x0er\flonely fieldR\x05field\"E\n" +
	"\bOneOfOne\x124\n" +
	"\fstring_field\x18\x01 \x01(\tB\x11\x9aI\x0er\fstring_fieldR\vstringField:\x03\xa0I\x01\"@\n" +
	"\bOneOfTwo\x124\n" +
	"\fstring_field\x18\x01 \x01(\tB\x11\x9aI\x0er\fstring_fieldR\vstringField\"G\n" +
	"\n" +
	"OneOfThree\x124\n" +
	"\fstring_field\x18\x01 \x01(\tB\x11\x9aI\x0er\fstring_fieldR\vstringField:\x03\x98I\x01BQZOgithub.com/onexstack/protobuf-go-plugins/cmd/protoc-gen-go-defaults/tests/pb;pbb\x06proto3"

var (
	file_tests_pb_types_proto_rawDescOnce sync.Once
	file_tests_pb_types_proto_rawDescData []byte
)

func file_tests_pb_types_proto_rawDescGZIP() []byte {
	file_tests_pb_types_proto_rawDescOnce.Do(func() {
		file_tests_pb_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tests_pb_types_proto_rawDesc), len(file_tests_pb_types_proto_rawDesc)))
	})
...
var file_tests_pb_types_proto_goTypes = []any{
...
func file_tests_pb_types_proto_init() {
	...
	file_tests_pb_types_proto_msgTypes[0].OneofWrappers = []any{
		(*Types_One)(nil),
		(*Types_Two)(nil),
		(*Types_Three)(nil),
		(*Types_Four)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tests_pb_types_proto_rawDesc), len(file_tests_pb_types_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
