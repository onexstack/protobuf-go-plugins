...
func (x *Test) GetOneof() isTest_Oneof {
	if x != nil {
		return x.Oneof
	}
	return nil
...
const file_tests_pb_test_proto_rawDesc = "" +
	"\n" +
	"\x13tests/pb/test.proto\x12\x05tests\x1a\x17defaults/defaults.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a google/protobuf/descriptor.proto\x1a\x14tests/pb/types.proto\"\x89\n" +
	"\n" +
	"\x04Test\x124\n" +
	...
	"\r_number_fieldB\r\n" +
	"\v_bool_fieldB\r\n" +
	"\v_enum_fieldBNZLgithub.com/onexstack/protobuf-go-plugins/cmd/protoc-gen-go-defaults/tests/pbb\x06proto3"
...
func file_tests_pb_test_proto_init() {
	...
	file_tests_pb_test_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
