...
var file_validate_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		ExtensionType: (*bool)(nil),
		Field:         1073,
		Name:          "validate.unexported",
		Tag:           "varint,1073,opt,name=unexported",
		Filename:      "validate.proto",
	},
	{
...
var (
	...
	// Unexported emits the rule body under the underscore-prefixed names
	// _Validate and _ValidateAll rather than the exported Validate and
	// ValidateAll.
	//
	// It pairs with a hand-written file that supplies the exported pair, calls
	// through to the generated body, and adds checks the rules cannot express
	// -- a cross-field comparison, a value that depends on another field. The
	// generated file is rewritten in full on every protoc run, so the hook has
	// to be a name the generator never claims; this is the counterpart of
	// defaults' (defaults.unexported).
	//
	// Unlike Ignored, which emits nothing for the message and so leaves the
	// hand-written method with no compiled rules to call, this one keeps every
	// rule, every error type and every lookup table -- only the two entry
	// points change name.
	//
	// optional bool unexported = 1073;
	E_Unexported = &file_validate_proto_extTypes[2]
)
...
const file_validate_proto_rawDesc = "" +
	...
	"\n" +
	"unexported\x12\x1f.google.protobuf.MessageOptions\x18\xb1\b \x01(\bR\n" +
	"unexported::\n" +
	"\brequired\x12\x1d.google.protobuf.OneofOptions\x18\xaf\b \x01(\bR\brequired:J\n" +
	"\x05rules\x12\x1d.google.protobuf.FieldOptions\x18\xaf\b \x01(\v2\x14.validate.FieldRulesR\x05rulesBX\n" +
	"\x1aio.envoyproxy.pgv.validateZ:github.com/onexstack/protobuf-go-plugins/validate;validate"
...
var file_validate_proto_depIdxs = []int32{
	...
	26, // 41: validate.unexported:extendee -> google.protobuf.MessageOptions
